...
const SUMMARY_THRESHOLD  = 30;   // summarise overflow when real messages exceed this
...
// Server variant extends the base prompt with email tool availability
const SYSTEM_PROMPT_SERVER = SYSTEM_PROMPT + `

═══════════════════════════════════════════
EMAIL TOOLS (SERVER MODE)
═══════════════════════════════════════════
